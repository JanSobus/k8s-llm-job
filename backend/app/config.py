...
class Settings(BaseSettings):
    ...
    worker_image_pdf: str = "cern-ml-demo-worker-pdf:local"
    worker_image_tabular: str = "cern-ml-demo-worker-tabular:local"
    kubernetes_namespace: str = "default"
    job_ttl_seconds_after_finished: int = 600
    job_name_prefix: str = "cern-ml-demo-wk-"
